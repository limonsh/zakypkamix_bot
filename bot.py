...
“template”: {
“sherif”: [“Maslo slivochnoe”, “Syr parmezan”, “Moloko”],
“japan”: [“Soevyy sous”, “Ris dlya sushi”, “Vasabi”],
“bazar”: [“Pomidory”, “Zelen”, “Ogurcy”],
“endis”: [“Muka pshenichnaya”, “Sahar”, “Maslo rastitelnoe”],
},
“zayavka”: {},
“zakupka_status”: {},
“zakazano”: [],
...
return “📞 Zakazano - zhdem postavku\nPozicij: “ + str(count)

def text_settings(d):
sec_count = len(d[“sections”])
item_count = sum(len(v) for v in d[“template”].values())
return “⚙️ Nastrojki\nRazdelov: “ + str(sec_count) + “ Tovarov: “ + str(item_count)
...
await q.edit_message_text(“➕ V kakoj razdel dobavit?”, reply_markup=InlineKeyboardMarkup(rows))
return
if data.startswith(“z:additem:sec:”):
sid = data.split(”:”, 3)[3]
ctx.user_data[“zadd”] = {“sid”: sid}
await q.message.reply_text(“➕ Nazvanie tovara dlya “ + sec_label(d, sid) + “:\n\n/cancel - otmena”)
...
d[“comments”][key] = text
await update.message.reply_text(“✅ Kommentarij sohranyon: “ + text)
save(d)
...
await update.message.reply_text(“Kommentarij dlya “ + name + “ (neobyazatelno):\n\n/skip - propustit”)
...
save(d)
await update.message.reply_text(“✅ “ + name + “ dobavlen v “ + sec_label(d, sid))
...
await update.message.reply_text(“Kommentarij k “ + name + “ (neobyazatelno):\n\n/skip - propustit”)
...
d[“comments”][sid + “:” + name] = text
save(d)
await update.message.reply_text(“✅ “ + name + “ dobavlen i otmechen v zayavke!”)
